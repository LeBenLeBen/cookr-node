...
>(
  ...
  undefined | ExtractSingleKey<NonNullable<TResult>, TResultKey>
>;
...
>(
  ...
  TDefaultValue | ExtractSingleKey<NonNullable<TResult>, TResultKey>
>;
 ...
 */
export default function useResult<TResult, TDefaultValue, TReturnValue>(
  result: Ref<TResult>,
...
export default function useResult<TResult, TDefaultValue, TReturnValue>(
  ...
  TResult | TResult[keyof TResult] | TDefaultValue | TReturnValue | undefined
> {
  return computed(() => {
